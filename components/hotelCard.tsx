    ...
    return (
        <View style={styles.cardWrapper}>
            ...
            <View style={{
                ...
                <Text style={{ color: '#534F4F', fontWeight: 'bold', fontSize: 11, marginLeft: 5, marginTop: 10 }}>Alibaba Hotel Da Nang</Text>
                ...
                <Text style={{ fontSize: 10, marginTop: 5, marginLeft: 5, color: '#FF6210', fontWeight: 'bold' }}>204.232 VND</Text>
            </View>
        </View>
    );
}
