...
const styles = StyleSheet.create({
  ...
  container: {
    marginVertical: 10,      // khoảng cách trên và dưới của nhóm box so với phần khác
    paddingHorizontal: 20,   // khoảng cách trái/phải bên trong lề (giúp box cách mép màn hình)
    marginTop: 10,           // đẩy xuống từ banner một chút
  },
  ...
  box: {
    ...
    padding: 15,             // khoảng cách nội bộ giữa viền box và nội dung
    // shadow cho iOS:
    shadowColor: '#000',
