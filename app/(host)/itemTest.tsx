...
import ItemsByRoomType from '@/components/host/screen/employee/itemsByRoomType';
        ...
        <>
            <View style={styles.container}>
                <Stack.Navigator screenOptions={{ headerShown: false }}>
                    <Stack.Screen name="ItemsByRoomType" component={ItemsByRoomType} />
                    <Stack.Screen name="ItemListHotel" component={ItemListHotel} />
                </Stack.Navigator>
            </View>
        </>
